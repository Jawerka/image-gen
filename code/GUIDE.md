...
- `width` — ширина изображения (768-2048, по умолчанию 1024)
- `height` — высота изображения (768-2048, по умолчанию 1024)
...
| `width` | 768-2048 | Ширина изображения |
| `height` | 768-2048 | Высота изображения |
